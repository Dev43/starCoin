...
var qtum = require('../../qtumLib/lib/index');
...
(function() {
	var methods = Object.getOwnPropertyNames(qtum.Client.prototype).filter(function(p) {
	    return typeof qtum.Client.prototype[p] === 'function' && p !== "cmd" && p!= "constructor";
	})
	  for (var i = 0 ; i<methods.length ; i++ ) {
		  var protoFn = methods[i] ;
	    (function(protoFn) {
	    	qtum.Client.prototype[protoFn] = function() {
	        var args = [].slice.call(arguments);
...
module.exports.Client = qtum.Client;
